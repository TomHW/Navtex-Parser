...
class Plugin(object):
	...
	CONFIG_URL={
			...
			'default':'http://tom-mh1-desktop:8000/',
			'type': 'STRING'
		}
	CONFIG_FILENAME={
		'name':'fileName',
		'description': 'name of the overlay file',
	...
	def __init__(self,api):
		...
		self.api.registerEditableParameters([self.CONFIG_URL,self.CONFIG_FILENAME, self.CONFIG_INTERVAL],self.changeConfig)
